...
<html>
	...
	<body>
		<div class="container">
			<form action='' method='post' role="form" class="form-horizontal" data-toggle="validator">
				...
				<div class="form-group">
	        		<div class="col-sm-9 col-sm-offset-3">
						<div class="checkbox">
							<label><input type="checkbox" name="check">Billing Detail Same As Shillping Detail</label>
						</div>
					</div>
				</div>
				<div class="form-group">
